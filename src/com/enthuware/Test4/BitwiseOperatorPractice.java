...
public class BitwiseOperatorPractice {
	...
	// this will check both conditon's ands increment or decrement in both of them
	...
	public static void main(String[] args) {
		...
		} else if ((d == ++c)|(d == ++c )) {//d equals 3 , then c gets pre-incremented and adds 1 so c equals 2, then d and c gets pre-incremented again then equals 3
		...
		if (a == 2)
			System.out.println("only ifs this will work");
